...
// Demo data - ACI Competency Framework for Educators (from Catalog)
          ...
          <DialogContent className="sm:max-w-[500px]">
            <DialogHeader>
              <DialogTitle className="flex items-center gap-2">
                ...
                Start AI-Powered Competency Assessment
              </DialogTitle>
              <DialogDescription>
                The AI will generate personalized competency questions based on your role and the ACI Framework from the Catalog
              </DialogDescription>
            </DialogHeader>
            <div className="space-y-4 py-4">
              ...
              <div className="rounded-lg bg-muted p-4">
                ...
                <ul className="text-sm text-muted-foreground space-y-1">
                  <li>• Questions based on ACI Competency Framework (from Catalog)</li>
                  <li>• Tailored to your specific job role and description</li>
          ...
          {isAssessmentActive && generatedQuestions.length > 0 && (
            <>
              ...
              <Card className="min-h-[400px]">
                ...
                <CardContent>
                  <div className="space-y-4">
                    <Label className="text-base font-medium">Rate your practice (1-5):</Label>
                    <RadioGroup
