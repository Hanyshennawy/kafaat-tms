...
-- This migration adds tables for AI-powered question generation and assessment building
...
VALUES (
  ...
  'active',
  '[
    {"code": "O", "name": "Openness to Experience", "description": "Intellectual curiosity, creativity, and preference for novelty"},
    {"code": "C", "name": "Conscientiousness", "description": "Self-discipline, organization, and goal-directed behavior"},
    {"code": "E", "name": "Extraversion", "description": "Energy, positive emotions, and tendency to seek stimulation"},
    {"code": "A", "name": "Agreeableness", "description": "Tendency to be compassionate and cooperative"},
    {"code": "N", "name": "Neuroticism", "description": "Tendency to experience negative emotions"}
  ]'::jsonb
...
VALUES (
  ...
  'active',
  '[
    {"code": "ADJ", "name": "Adjustment", "description": "Confidence, self-esteem, and composure under pressure"},
    {"code": "AMB", "name": "Ambition", "description": "Initiative, competitiveness, and desire for leadership roles"},
    {"code": "SOC", "name": "Sociability", "description": "Need for social interaction and preference for working with others"},
    {"code": "INT", "name": "Interpersonal Sensitivity", "description": "Perceptiveness and ability to maintain relationships"},
    {"code": "PRU", "name": "Prudence", "description": "Self-discipline, responsibility, and thoroughness"},
    {"code": "INQ", "name": "Inquisitive", "description": "Imagination, curiosity, and creative potential"},
    {"code": "LRN", "name": "Learning Approach", "description": "Enjoyment of learning and staying current"}
  ]'::jsonb
) ON CONFLICT (code) DO NOTHING;
...
VALUES (
  ...
  'active',
  '[
    {"code": "TL", "name": "Teaching & Learning", "description": "Lesson Planning, Instructional Delivery, Differentiation, Technology Integration"},
    {"code": "SS", "name": "Student Support", "description": "Classroom Management, Student Wellbeing, Parent Engagement, Special Needs"},
    {"code": "PG", "name": "Professional Growth", "description": "Continuous Learning, Collaboration, Innovation, Mentoring"}
  ]'::jsonb
) ON CONFLICT (code) DO NOTHING;
