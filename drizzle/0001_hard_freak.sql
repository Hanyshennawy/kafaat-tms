...
--> statement-breakpoint
ALTER TABLE `users` MODIFY COLUMN `role` enum('super_admin','hr_manager','department_manager','employee','licensing_officer','recruiter') NOT NULL DEFAULT 'employee';--> statement-breakpoint
ALTER TABLE `users` ADD `emiratesId` varchar(64);--> statement-breakpoint
